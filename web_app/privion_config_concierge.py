    ...
    for key in keys:
        if key in config:
            ...
            default_value = {
                ...
                'draft_models_dir':base_directory + '/models/draft_models',
                ...
                'searxng_dir': base_directory + '/searxng',
                ...
                'llama_cpp_serving_url':'127.0.0.1',
                'llama_cpp_access_url':'localhost',
                'llama_cpp_server_port':8080,
                'legacy_mode':False,
                'tool_response_mode':'user_tool_response_tag',
                'do_rag':True,
                'butler_mode':False,
                ...
                'llama_cpp_alias':'',
                'llama_cpp_misc_args':'',
                'llama_cpp_check_tensors':False,
                'llama_cpp_verbose':False,
                'llama_cpp_special_tokens_output':False,
                'llama_cpp_reasoning_budget':-1,
                ...
                'llama_cpp_main_gpu_index':0,
                'llama_cpp_tensor_split':None,
                'llama_cpp_override_tensor':None,
                ...
                'govee_device_search_max_attempts':5,
                'enable_asr':False,
                'asr_wake_word':'marcus',
                'asr_model':'nvidia/parakeet-tdt-0.6b-v2',
                'asr_torch_device':'cuda:0',
                'asr_temperature':0.0,
                ...
                'respect_robots':True,
                'max_url_context_chars':11000,
                'fetch_url_timeout_seconds':15,
                'assign_host_port_to_searxng_server':8977,
                # 'assign_host_port_to_perplexica_server':3003,
                # 'perplexica_version':'latest',
                # 'perplexica_embedding_model':'Xenova/all-MiniLM-L6-v2',
                # 'perplexica_optimization_mode':'speed',
                # 'perplexica_sources':['web', 'discussions'],
                # 'perplexica_include_history':False,
                # 'perplexica_system_instructions':'Prioritize accuracy and relevance.',
