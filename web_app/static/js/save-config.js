...
function getLlmConfig() {
    ...
    if (useLocalLlmRadioButton.checked) {
        ...
        if (config.local_llm_server === "llama-cpp") {
            ...
            config.llama_cpp_cuda_all_devices = document.getElementById('CudaAllDevicesCheckbox').checked;
            config.llama_cpp_cuda_specific_devices = document.getElementById('CudaSpecifyDevices').value;
...
function getOcrConfig() {
    ...
    } else if (window.getComputedStyle(docling_div).display != 'none') {
...
function getHfWaitressConfig() {
    let hf_config = {
        ...
        'flux_low_vram_optimizations': document.getElementById('hf_waitress_diffusers_low_vram_optimizations_checkbox').checked,
        'load_quantized_flux': document.getElementById('hf_waitress_diffusers_fp8_checkbox').checked,
        ...
        'exl2_no_flash_attn': document.getElementById('hf_use_exl2_no_flash_attn_checkbox').checked,
        ...
        'exl3_cache_type': document.getElementById('hf_waitress_exl3_cache_type_choice').value,
        'exl3_k_bits': parseInt(document.getElementById('HfwExl3KBits').value),
        'exl3_v_bits': parseInt(document.getElementById('HfwExl3VBits').value),
        ...
        'return_full_text': document.getElementById('hf_waitress_return_full_text_checkbox').checked,
