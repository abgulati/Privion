...
docker_only_config_path = '/app/lars_storage/config.json'    # we already know that a docker env is linux-debian, no need to wait for platform detection logic further below!
...
docker_only_hf_config_path = '/app/lars_storage/waitress_storage/hf_config.json'
def read_hf_config(keys, default_value=None, filename=docker_only_hf_config_path):
